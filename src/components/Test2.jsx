...
const Test2 = () => {
  ...
  const isSection1Visible = useOnScreen(section1, "-300px");
  const isSection2Visible = useOnScreen(section2, "-300px");
  const isSection3Visible = useOnScreen(section3, "-300px");
  const isSection4Visible = useOnScreen(section4, "-300px");
  const isSection5Visible = useOnScreen(section5, "-300px");
  const isFooterVisible = useOnScreen(footer, "-300px");
  ...
  return (
    <div className="static font-mont">
      {/* Logo */}
      <motion.div
        ref={logoRef}
        className="fixed left-32 top-10 z-10 cursor-pointer"
      ...
      <nav className={`hidden ${isFooterVisible ? "md:hidden" : "md:block"}`}>
      ...
      <div className="font-mont">
        <Element name="section1">
          <div
            ref={section1}
            className="h-screen bg-slate-500 lg:snap-start lg:snap-always"
            id="section1"
          >
            <Hero />
          </div>
        ...
        <Element name="section2">
          <div
            ref={section2}
            className="h-screen bg-blue-500 lg:snap-start lg:snap-always"
            id="section2"
          >
            <Skills />
          </div>
        ...
        <Element name="section3">
          <div
            ref={section3}
            className="h-screen bg-red-500 lg:snap-start lg:snap-always"
            id="section3"
          >
            <OverTheYear />
          </div>
        ...
        <Element name="section4">
          <div
            ref={section4}
            className="h-screen bg-yellow-500 lg:snap-start lg:snap-always"
            id="section4"
          >
            <ToMyProject />
          </div>
        ...
        <Element name="section5">
          <div
            ref={section5}
            className="h-screen bg-lime-500 lg:snap-start lg:snap-always"
            id="section5"
          >
            <ContactMe />
          </div>
